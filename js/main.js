...
setTimeout(() => {
  new Typewriter(".typing-text", {
    strings: ["Frontend Developer", "UI/UX Designer", "Photographer"],
    autoStart: true,
    loop: true,
    deleteSpeed: 50,
    delay: 100,
...
new Typewriter(".loading-text", {
  strings: ["Pavani VLN Charan Is Thinking..."],
  autoStart: true,
  delay: 50,
  cursor: "|",
  deleteSpeed: 10,
...
const projectData = [
  {
    ...
    srcURL: "https://github.com/charanvlnpavani/react-fitness-exercise",
    liveDemo: "https://react-fitness-exercise.vercel.app/",
  },
  {
    title: "Youtube Clone",
...
function downloadCV() {
  ...
  link.download = "Charan_frontend_resume.pdf";
  link.href = "./files/Charan_frontend_resume.pdf"; // Ensure this path is correct
